  ...
  return (
    <section
      ...
      style={{
        ...
        borderRadius: '14px',
        background: 'linear-gradient(135deg, rgba(141,247,255,0.10), rgba(124,58,237,0.08))',
        boxShadow: '0 12px 36px rgba(0,0,0,0.18)'
      }}
    >
      <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',gap:'12px',flexWrap:'wrap'}}>
        <div>
          <div style={{fontSize:'10px',letterSpacing:'0.14em',textTransform:'uppercase',color:'#8df7ff',fontWeight:800}}>
            {label}
          </div>
